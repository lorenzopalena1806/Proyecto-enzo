...
const newTitleRender = `                    <div className="relative z-10 flex flex-col h-full">
                      ...
                      <h3 className={\`font-bold text-lg text-white mb-2 pr-16 leading-tight drop-shadow-md \${offer.image_url && offer.image_display_mode === 'contain' ? 'mt-2' : 'mt-8'}\`}>{offer.title}</h3>`;
...
console.log('Done client merchant page');
