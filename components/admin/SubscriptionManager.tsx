      ...
      <div className="flex flex-col gap-2 mb-4">
        ...
        <div className="flex flex-col xl:flex-row gap-3">
          <input
            ...
            className="w-full bg-slate-950 border border-slate-700 rounded-xl px-4 py-2.5 text-white focus:outline-none focus:ring-2 focus:ring-violet-500"
          />
          <button
            onClick={handleSave}
            disabled={loading}
            className="w-full xl:w-auto px-5 py-2.5 bg-violet-600 hover:bg-violet-700 text-white font-medium rounded-xl transition-colors disabled:opacity-50 flex items-center justify-center whitespace-nowrap"
          >
