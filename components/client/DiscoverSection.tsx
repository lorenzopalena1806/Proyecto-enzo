    ...
    <div className="space-y-6 overflow-hidden">
      ...
      <div id="tour-client-search" className="flex gap-3 relative z-[1]">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Buscar comercios, categorías o marcas..."
            aria-label="Buscar comercios, categorías o marcas"
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
            className="w-full bg-slate-900/80 border border-slate-700/50 rounded-2xl py-3 pl-10 pr-4 text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 placeholder:text-slate-500"
          />
        </div>
        <Link
          href="/client/map"
